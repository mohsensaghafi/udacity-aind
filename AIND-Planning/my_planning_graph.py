...
class PlanningGraph():
    ...
    def add_literal_level(self, level):
        ...
        """        
        prev_a_level = self.a_levels[level - 1] # Previous action level (previous to this level of states)
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # intersection of the effect_add an deffect_rem should be empty
        intersect_set_1 = set(node_a1.action.effect_add).intersection(set(node_a2.action.effect_rem))
        intersect_set_2 = set(node_a2.action.effect_add).intersection(set(node_a1.action.effect_rem))
        return bool(intersect_set_1) or bool(intersect_set_2)
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # intersection of the effect_add and precond_ned ,and effect_rem and deffect_rem should be empty
        intersect_set_1 = set(node_a1.action.effect_add).intersection(set(node_a2.action.precond_neg))
        intersect_set_2 = set(node_a1.action.effect_rem).intersection(set(node_a2.action.precond_pos))
        intersect_set_3 = set(node_a2.action.effect_add).intersection(set(node_a1.action.precond_neg))
        intersect_set_4 = set(node_a2.action.effect_rem).intersection(set(node_a1.action.precond_pos))
        return bool(intersect_set_1) or bool(intersect_set_2) or bool(intersect_set_3) or bool(intersect_set_4)
